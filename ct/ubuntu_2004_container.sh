...
while true; do
    read -p "This will create a New Ubuntu 20.04 LXC Container. Proceed (y/n)?" yn
    case $yn in
        [Yy]* ) break;;
        [Nn]* ) exit;;
...
wget -qL https://raw.githubusercontent.com/StevenSeifried/Proxmox/main/setup_files/ubuntu_setup.sh
...
OSTYPE=ubuntu
OSVERSION=${OSTYPE}-20.04-standard
